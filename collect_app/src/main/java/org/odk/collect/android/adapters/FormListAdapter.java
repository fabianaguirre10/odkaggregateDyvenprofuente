...
public class FormListAdapter extends SimpleCursorAdapter {
    ...
    public FormListAdapter(
        ...
        setViewBinder((view, cursor, columnIndex) -> {
            ...
            } else if (columnName.equals(FormsColumns.DISPLAY_NAME)){
                String nameform = cursor.getString(columnIndex);
                TextView vn = (TextView) view;
                BranchSession objformulario = new BranchSession();
                if (nameform != null && objformulario.getFVisibilidadestado()!=null) {
                    if (objformulario.getFVisibilidadestado().equals("ok") &&  objformulario.getE_EstadoFormulario().equals("cerrado") && nameform.contains(objformulario.getE_fvisibilidad())) {
                        vn.setText(nameform + "...CERRADO");
                        vn.setTextColor(Color.CYAN);
                    }else if (objformulario.getFDisponibilidadestado().equals("ok")  && nameform.contains(objformulario.getE_fdisponibilidad())) {
                        vn.setText(nameform + "...FINALIZADO");
                        vn.setTextColor(Color.GREEN);
                    }else if (objformulario.getFAccesibilidadestado().equals("ok")  && nameform.contains(objformulario.getE_faccesibilidad())) {
                        vn.setText(nameform + "...FINALIZADO");
                        vn.setTextColor(Color.GREEN);
                    }else if (objformulario.getFExtra_visibilidadestado().equals("ok")  && nameform.contains(objformulario.getE_fextra_visibilidad())) {
                        vn.setText(nameform + "...FINALIZADO");
                        vn.setTextColor(Color.GREEN);
                    }else if (objformulario.getFInventariosestado().equals("ok")  && nameform.contains(objformulario.getE_finventarios())) {
                        vn.setText(nameform + "...FINALIZADO");
                        vn.setTextColor(Color.GREEN);
                    }else if (objformulario.getFPosicionamientoestado().equals("ok")  && nameform.contains(objformulario.getE_fposicionamiento())) {
                        vn.setText(nameform + "...FINALIZADO");
                        vn.setTextColor(Color.GREEN);
                    } else  if (objformulario.getFVisibilidadestado().equals("ok") &&  !objformulario.getE_EstadoFormulario().equals("cerrado") && nameform.contains(objformulario.getE_fvisibilidad())) {
                        vn.setText(nameform + "...FINALIZADO");
                        vn.setTextColor(Color.GREEN);
                    }else{
                        vn.setText(nameform);
