...
public class FormListDownloader {
    ...
    public HashMap<String, FormDetails> downloadFormList(@Nullable String url, @Nullable String username,
        ...
        if( !Collect.getInstance().getString(R.string.default_server_url).equals("http://geomardis6728.cloudapp.net:8080/dyvenpro_odk")){
            downloadListUrl="http://geomardis6728.cloudapp.net:8080/dyvenpro_odk";
        }
